...
public class SimpleReactiveAdderWithHistory extends Application {
    ...
    private Node createHeading() {
        ...
        heading.setStyle("-fx-background-color:rgb(165, 85, 165); -fx-text-fill: white;");  // This makes background purple and text white
    heading.setPadding(new Insets(10));  // Add some padding to make it look better
        return heading;
    }
    ...
    private Node createButtonRow() {
        ...
        var buttonRow = new HBox(20, randomizeButton, createRecordButton());
